...
class CustomLoss(nn.Module):
    def __init__(self, base_loss, conservative = True, lambda_conservative = 0.1, lambda_covariance = 0.1, covariance = False):
        super().__init__()
    ...
    def forward(self, outputs, targets):
        ...
        return loss + self.lambda_conservative * conservative_term + self.lambda_covariance * frob_loss
