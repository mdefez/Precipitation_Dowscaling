...
# Simple training uses all the data as training data
...
def main(train_dataset, val_dataset, normalizing, strat_precip, strat_dem,
        ...
        temp_factor, spatial_factor, model, model_parameters, treshold_constraint, testing):
    ...
    return weights, loss, stats_precip, stats_dem
...
def k_fold(dico_dataset, normalizing, strat_precip, strat_dem, batch_size, epochs, scheduler, learning_rate, 
                    loss_function, name_of_the_run, temp_factor, spatial_factor, model, model_parameters, treshold_constraint):
    ...
    for k in range(len(splits)):
        ...
        weights, loss, stats_precip, stats_dem = main(train_dataset, val_dataset, normalizing, strat_precip, strat_dem,
                                                      batch_size, epochs, scheduler, learning_rate, loss_function, k, name_of_the_run, 
    ...
    return best_model_state, best_val_score, stats_precip, stats_dem
...
def simple_training(dico_dataset, normalizing, strat_precip, strat_dem, batch_size, epochs, scheduler, learning_rate, 
    ...
    weights, loss, stats_precip, stats_dem = main(train_dataset, None, normalizing, strat_precip, strat_dem,
                                                      batch_size, epochs, scheduler, learning_rate, loss_function, None, name_of_the_run, 
                                                      temp_factor, spatial_factor, model, model_parameters, treshold_constraint, testing = False)
