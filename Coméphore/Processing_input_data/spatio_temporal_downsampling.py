...
if download_specific_folder == True:
    ...
    temporal_downscaled_data_path = "/work/FAC/FGSE/IDYST/tbeucler/downscaling/mdefez/Comephore/lil_dataset/interm_data"
    ...
    temporal_downscaled_data_path = "/work/FAC/FGSE/IDYST/tbeucler/downscaling/mdefez/Comephore/downsampled_data/interm_data"
    input_data = "/work/FAC/FGSE/IDYST/tbeucler/downscaling/mdefez/Comephore/downsampled_data/input_data"

    for month in range(1, 13):
        original_data_path = f"/work/FAC/FGSE/IDYST/tbeucler/downscaling/mdefez/Comephore/Projected_data/{year}/COMEPHORE_{year}_{month}/{year}"
